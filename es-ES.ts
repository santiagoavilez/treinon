...
export const esES: LocalizationResource = {
  ...
  unstable__errors: {
    ...
    passwordComplexity: {
      sentencePrefix: "Tu contraseña es ",
      minimumLength: "debe tener al menos {{length}} caracteres",
      maximumLength: "demasiado larga",
      requireNumbers: "Se requiere al menos un número",
      requireLowercase: "Se requiere al menos una letra minúscula",
      requireUppercase: "Se requiere al menos una letra mayúscula",
      requireSpecialCharacter: "Se requiere al menos un carácter especial",
    },
    zxcvbn: {
      couldBeStronger:
        "Tu contraseña esta bien, pero podria ser mas segura. Intenta añadir mas caracteres.",
      goodPassword:
        "Tu contraseña cumple con todos los requerimientos necesarios.",
